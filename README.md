...
```
81 kanałów RSS  →  filtr dnia X-1  →  grupowanie w tematy  →  ranking  →  pogłębienie  →  JSON  →  aplikacja
```

1. **Zbiórka.** O 8:00 czasu polskiego kolektor pobiera 81 kanałów RSS (polskich i zagranicznych)
...
collector/          kolektor: źródła, pobieranie, ranking, pogłębianie, zapis
  sources.py        katalog 81 kanałów w 10 działach
