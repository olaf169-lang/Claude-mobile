...
dlatego kryteria od 2 do 4. Urwane sety i punkty z tablicy nie są walutą, tylko linijką
...
- **Przydomki**: szesnaście ksywek bojowych z własnymi godłami SVG, liczonych na
  ...
  | 🥈 | Samotny Wilk | ≥ 60% wygranych w singlu i ≤ 35% w deblu |
...
wygrał. Jedyny wyjątek to urwany set: wygrana 2:0 waży 1,0, wygrana 2:1 daje 0,85,
przegrana 1:2 daje 0,15, a przegrana 0:2 zero. Urwać komuś seta to jednak coś.
...
(święta, Sylwester) oraz **30 marca**, bo wypada zaraz po Wielkanocy i zostaje terminem
...
4,2:1, czyli za mało na liczby w tabeli, i stąd wybór granatu.
