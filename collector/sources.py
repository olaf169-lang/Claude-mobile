...
SEGMENTS: tuple[Segment, ...] = (
    ...
    Segment(
        ...
        boost=(
            ...
            "final", "title", "medal", "championship", "bundesliga", "serie a",
            "ligue 1", "bayern", "real madryt", "barcelona", "manchester",
            "liverpool", "juventus", "psg", "atp", "wta", "nhl", "mlb", "ufc",
            "formuła 1", "tour de france", "giro", "vuelta", "euroliga",
        ),
    ...
    Segment(
        ...
        feeds=(
            ...
            _f("https://naukawpolsce.pl/rss.xml", "Nauka w Polsce", weight=1.15, topical=False),
            _f("https://www.crazynauka.pl/feed/", "Crazy Nauka", weight=1.0, topical=False),
        ),
        boost=(
    ...
    Segment(
        ...
        feeds=(
            ...
            _f("https://geoforum.pl/rss", "Geoforum", weight=1.0, topical=False),
            _f("https://naukawpolsce.pl/rss.xml", "Nauka w Polsce", weight=1.1, topical=False),
            _f("https://www.crazynauka.pl/feed/", "Crazy Nauka", weight=1.0, topical=False),
        ),
        boost=(
    ...
    Segment(
        ...
        feeds=(
            ...
            _f("https://kultura.onet.pl/.feed", "Onet Kultura", weight=0.95, topical=False),
